              ...
              <section className="flex flex-col gap-4">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <p className="text-sm text-muted-foreground">Nom et prénom affichés dans l&apos;application.</p>
                  </div>
                </div>
                <form
            ...
            <section className="flex flex-col gap-4">
              <div className="flex items-start gap-3">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <p className="text-sm text-muted-foreground">Mode par défaut pour vos nouvelles recherches.</p>
                </div>
              </div>
              <ToggleGroup
                type="single"
